...
train_dir = '/content/drive/My Drive/chest_xray_kid_jpeg/train'
val_dir = '/content/drive/My Drive/chest_xray_kid_jpeg/val'
...
for epoch in range(num_epochs):
    ...
    if val_accuracy > best_val_acc:
        ...
        model_path = os.path.join(models_dir, 'resnet50_model_v2_kid.pth')
